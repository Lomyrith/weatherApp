export function getConditionImagePath(code, isDay = 1) {
  ...
  return condition
    ? //C:\code\projects\DevKarriere\weatherApp\public\conditionImages
      // "../../public/conditionImages/" + condition[isDay ? "day" : "night"]
      "/weatherApp/conditionImages/" + condition[isDay ? "day" : "night"]
    : null;
}
